...
function removeElements()
{
    ...
    elementRendered('[href="edit.php?post_type=wp_block"]', element =>
    {
        element.remove()
    })

    // Publish button
    elementRendered('.editor-post-publish-button', element =>
    {
        element.style.display = 'none'
    })
    elementRendered('.editor-post-publish-panel__toggle', element =>
    {
        element.style.display = 'none'
    })

    // Remove article button
    elementRendered('.editor-post-trash', element =>
    {
        element.remove()
    })

    elementRendered('.editor-post-saved-state', element =>
    {
        element.style.display = 'none'
    })
